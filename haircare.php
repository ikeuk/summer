...
<?php
							...
							$self = $_SERVER['PHP_SELF'];
								...
								//query
								$sql = "SELECT * FROM stretcher ORDER BY id ASC";
								$query = $sql.$limit;
								...
								<?php
									$sql1 = "SELECT * FROM stretcher ORDER BY id ASC";
		...
		<div class="container">
			...
			<div class="col-md-3 gallery-grid gallery-grid1 wow flipInY animated" data-wow-delay=".7s">
					...
					<div class="gallery-text simpleCart_shelfItem">
						<h5><a class="name" href="single.php?basic=<?php echo $r['id']; ?> "><?php echo $r['productname']; ?> </a></h5>
